...
let AreaOfTheRectangle =(a,b) =>a*b;
console.log(AreaOfTheRectangle(23,4));
// #ETGAxbEn8l
// - створити функцію яка обчислює та повертає площу кола з радіусом r
// #Mbiz5K4yFe7
let AreaOfTheRound =(r) => Math.PI*r*r;
console.log(AreaOfTheRound(4));
// #Mbiz5K4yFe7
// - створити функцію яка обчислює та повертає площу циліндру висотою h, та радіутом r
let AreaOfTheCylinder=(radius,height) => 2*Math.PI*radius*height;
...
ArrayBuildList([1,2,3,"okten","study",true,false])
// #bovDJDTIjt
// - створити функцію яка приймає масив об'єктів з наступними полями id,name,age , та виводить їх в документ. Для кожного об'єкту окремий блок.
let ArrayOfObjectsFilterKey=(ArrayOfObjects)=> {
